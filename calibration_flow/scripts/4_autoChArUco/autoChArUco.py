...
def main(SOURCE_IMAGE_PATH, ROS_GOAL_PATH, EXTMAT_PATH, output_pattern_img=False):
...
if __name__ == "__main__":
    ...
    EXTMAT_PATH = 'goal/As.yaml'
    main(SOURCE_IMAGE_PATH, ROS_GOAL_PATH, EXTMAT_PATH)